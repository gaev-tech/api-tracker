...
class MagicToken(Base):
    """architecture.md §3.6.2 — magic_tokens(token_hash, email, intent, expires_at, used_at)."""
...
class CliAuthCode(Base):
    ...
    code_hash: Mapped[str | None] = mapped_column(String(128), nullable=True, unique=True)
